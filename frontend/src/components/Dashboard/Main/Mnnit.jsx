...
function Mnnit() {
    ...
    function openWebsite() {
        window.open('http://www.nitjsr.ac.in/', '_blank');
      }
  return (
    ...
    <div className='Mnnit_div'style={{fontFamily:"Agbalumo"}}>
      <div className="abcd"style={{fontFamily:"Agbalumo"}}>
        ...
        <span className='Mln_text'>National Institute of</span>
        <span className='Mln_text'>Technology Jamshedpur</span>
        </div>
...
<span class="relative text-white">NIT JSR</span>
</span>
</button>
<p>Nit Jsr Official Website</p>
      </div>
      </div>
    </div>
  )
